function [] = sensorplot_clusterStatsTFR_3D(n, sessions)
...
for session = sessions,
    ...
    for d = 1:2,
        ...
        grandavg = ft_selectdata(struct(), grandavg);
    ...
    save(sprintf('%s/%s-S%d_%s_%s_freqstats3D.mat', subjectdata.statsdir, ...
