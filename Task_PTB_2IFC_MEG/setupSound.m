function [audio, sound, setup] = setupSound(setup, audio)

% auditory feedback
setup.feedbackcounterbalance = repmat([1 1 2 2], 1, 30);
...
[sound.tonebuf, sound.tonepos] = CreateAudioBuffer(CreateTone(sound.stimonset, 0.050, audio.freq), ...
    ...
    CreateTone(sound.feedback.incorrect ,1, audio.freq)); % stim, 
