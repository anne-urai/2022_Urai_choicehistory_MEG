function [setup, dots, fix, results, sound, flip, trigger] = configuration_staircase_2IFC(window, audio, setup)

% general experimental design
setup.cohlevels         = setup.threshold;
setup.baselinecoh       = .7;
setup.trialrep          = 100; % nr of trials for the staircase
setup.totalntrials      = setup.trialrep;
setup.nblocks           = 2;
...
% use same pupilreboundtimes as in MEG to practice
...
results.breaktimestart = nan(setup.nblocks, setup.ntrials);
end