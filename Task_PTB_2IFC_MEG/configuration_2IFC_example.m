function [setup, dots, fix, results, sound, flip, coord, trigger] = configuration_2IFC_example(window, audio, setup)

% general experimental design
setup.baselinecoh       = .7; %70% baseline coherence, great for MEG
setup.trialrep          = 8; %600; %nr of trials over the whole session - 600 for MEG, more for training?
